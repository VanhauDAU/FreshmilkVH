    ...
    <div class="container">
        ...
        <div class="content manage_customer" id="content">
            ...
            <div class="data_customer">
                <a href="./add_info_customer.php">Thêm mới</a>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_info_customer.php?MaKH=<?php echo $row['MaKH']; ?>">Cập nhật</a>
                            </td>
                            <td>
                                <a href="delete_customer.php?MaKH=<?php echo $row['MaKH']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')"><i class="fa-solid fa-trash-can"></i></a></td>
                            </td>
                        </tr>
                <?php
                    }
