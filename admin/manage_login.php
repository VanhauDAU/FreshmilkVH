    ...
    <div class="container">
        ...
        <div class="content manage_customer" id="content">
            ...
            <div class="data_customer">
                <a href="./add_info_login.php">Thêm mới</a>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_info_login.php?id_user=<?php echo $row['id_user']; ?>">Cập nhật</a>
                            </td>
                            <td>
                                <a href="delete_login.php?id_user=<?php echo $row['id_user']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')"><i class="fa-solid fa-trash-can"></i></a></td>
                            </td>
                        </tr>
                <?php
                    }
