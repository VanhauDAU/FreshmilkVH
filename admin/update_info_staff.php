...
<?php
	...
	$sql = "select * from manage_staff where MaNV = '$MaNV'";
	...
	if(isset($_POST["btn-update-staff"]))
{
    ...
    if($result)
    {
        //đóng kết nối và chuyển trang manage_staff.php
        mysqli_close($conn);
                    ...
                    <form action="" autocomplete="off" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="MaNV" id="MaNV" value="<?php echo $row['MaNV']; ?>" size="5" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" value="<?php echo $row['TenNV']; ?>" id="TenNV" name="TenNV" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="date" value="<?php echo $row['NgaySinh']; ?>" id="NgaySinh" name="NgaySinh" required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="MaPB" id="MaPB">
                                        <?php
                                        while($rowMaPB = mysqli_fetch_assoc($result)){
                                            ?>
                                            <option value="<?php echo $rowMaPB['MaPB']; ?>" <?php if($row['MaPB'] == $rowMaPB['MaPB']) echo 'selected'; ?>>
                                                <?php echo $rowMaPB['TenPB']; ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text"  value="<?php echo $row['DiaChi']; ?>" id="DiaChi" name="DiaChi" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" size="15" id="DienThoai" name="DienThoai" required value="<?php echo $row['DienThoai']; ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <div class="btn">
                            <button type="submit" name="btn-update-staff">Cập nhật</button>
                        </div>
                    </form>
                    <div class="cow">
