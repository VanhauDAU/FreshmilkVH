...
<?php
	...
	if(isset($_POST["btn-add-brand"]))
	{
        ...
        $Email = $_POST["Email"];
		$sql = "insert into manage_brand(MaHS, TenHS, DiaChi, DienThoai, Email)
							values('$MaHS', '$TenHS', '$DiaChi', $DienThoai, '$Email')";
		//thực hiện insert
...
?>
    <div class="container update-info" style="height: 100vh;">
        <div class="content-body">
            ...
            <div class="content">
                <h1 class="title">Thêm mới thông tin hãng sữa</h1>
                <div class="form">
                    <form action="" autocomplete="off" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="MaHS" id="MaHS" placeholder="VD: VNM" size="5" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" placeholder="VD: Vinamilk" id="TenHS" name="TenHS" required>
                                </td>
                            </tr>
                        ...
                        <div class="btn">
                            <button type="submit" name="btn-add-brand">Thêm mới</button>
                        </div>
                    </form>
                    <div class="cow">
