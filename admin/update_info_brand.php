...
<?php
	...
	$sql = "select * from manage_brand where MaHS = '$MaHS'";
	...
	if(isset($_POST["btnCapnhat"]))
	{
		...
		$Email = $_POST["Email"];
		$sql = "update manage_brand set  MaHS = '$MaHS',
        TenHS = '$TenHS',
                                            DiaChi = '$DiaChi',
                                            DienThoai = '$DienThoai',
                                            Email = '$Email'
...
?>
    <div class="container update-info" style="height: 100vh;">
        <div class="content-body">
            ...
            <div class="content">
                <h1 class="title">Cập nhật thông tin Hãng Sữa</h1>
                <div class="form">
                    <form action="" autocomplete="off" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="MaHS" id="MaHS" value="<?php echo $row['MaHS']; ?>" size="5" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" value="<?php echo $row['TenHS']; ?>" id="TenHS" name="TenHS" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
