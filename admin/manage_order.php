        ...
        <div class="content manage_customer" id="content">
            <div class="header-top">
                <div class="header-top__content">
                    ...
                    <h1 class="title">Quản lý Đơn Đặt Hàng</h1>
                </div>
            </div>
            <div class="data_customer">
                <a href="./add_info_staff.php">Thêm mới</a>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_info_order.php?SoHD=<?php echo $row['SoHD']; ?>">Xem chi tiết</a>
                            </td>
                            <td>
                                <a href="delete_order.php?SoHD=<?php echo $row['SoHD']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')"><i class="fa-solid fa-trash-can"></i></a></td>
                            </td>
                        </tr>
                <?php
                    }
