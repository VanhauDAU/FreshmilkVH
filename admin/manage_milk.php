        ...
        <div class="content manage_customer" id="content">
            <div class="header-top">
                <div class="header-top__content">
                    ...
                    <h1 class="title">Quản lý Sản Phẩm Sữa</h1>
                </div>
            </div>
            <div class="data_customer">
                <a href="./add_info_milk.php">Thêm mới</a>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_info_milk.php?MaSP=<?php echo $row['MaSP']; ?>">Cập nhật</a>
                            </td>
                            <td>
                                <a href="delete_milk.php?MaSP=<?php echo $row['MaSP']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')"><i class="fa-solid fa-trash-can"></i></a></td>
                            </td>
                        </tr>
                <?php
                    }
