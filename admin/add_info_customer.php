...
<?php
	...
	if(isset($_POST["btn-add-customer"]))
	{
        ...
        $Email = $_POST["Email"];
		$sql = "insert into manage_customer(MaKH, TenKH, GioiTinh, DiaChi, DienThoai, Email)
							values('$MaKH', '$TenKH', $GioiTinh, '$DiaChi', $DienThoai, '$Email')";
		//thực hiện insert
...
?>
    <div class="container update-info" style="height: 100vh;">
        <div class="content-body">
            ...
            <div class="content">
                <h1 class="title">Thêm mới thông tin khách hàng</h1>
                <div class="form">
                    <form action="" autocomplete="off" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="MaKH" id="MaKH" placeholder="VD: KH01" size="5" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" placeholder="VD: Nguyen Van A" id="TenKH" name="TenKH"required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <div class="btn">
                            <button type="submit" name="btn-add-customer">Thêm mới</button>
                        </div>
                    </form>
                    <div class="cow">
